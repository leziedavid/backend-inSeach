...
export class FilterParamsDto {
    ...
    @ApiPropertyOptional({ example: "uuid-subcategory", description: "Filtrer par subCategoryId (optionnel)" })
    @IsOptional()
    @IsString()
    subCategoryId?: string;

    @ApiPropertyOptional({ example: true, description: "Filtrer uniquement les produits best-sellers" })
    @IsOptional()
    @IsBoolean()
